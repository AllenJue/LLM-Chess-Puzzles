...
try:
    ...
    try:
        from openai import RateLimitError, APIError, ServiceUnavailableError, APIConnectionError
    except ImportError:
        # For newer versions, use generic exceptions
...
support_models = ['gpt-3.5-turbo', 'gpt-3.5-turbo-0301', 'gpt-3.5-turbo-instruct', 'gpt-4', 'gpt-4-0314']
